...
{
    /// <inheritdoc />
    public partial class Addmessageandfriendshiptables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FriendShipInitiator = table.Column<Guid>(type: "uuid", nullable: false),
                    FriendShipCreationDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
